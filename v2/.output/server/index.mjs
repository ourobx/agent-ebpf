...
var public_assets_data_default = {
	"/favicon.svg": {
		"type": "image/svg+xml",
		"etag": "\"170-nelqe4535PM/Weyns4C6yEd/1r0\"",
		"mtime": "2026-09-01T06:08:50.166Z",
		"size": 368,
		"path": "../public/favicon.svg"
	},
	"/og.jpg": {
		"type": "image/jpeg",
		"etag": "\"7883-fqIXAwmPAjE3ezf/eDLFgul9y1o\"",
...
var grokOgIdentity = { "site": {
	"title": "KSEC",
	"card": "custom",
	"description": "Autonomous Ring-0 Defense Engine for Enterprise AI",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_Vdog4r = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_Vdog4r
	};
	return ((_m, p) => {
		return {
			data,
